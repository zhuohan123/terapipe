...
./pipemegatron_latency_model.sh gpt3-13b-4096 8 8 10 --mixed-precision
./pipemegatron_latency_model.sh gpt3-13b-6144 8 4 10 --mixed-precision
./pipemegatron_latency_model.sh gpt3-13b-8192 8 2 10 --mixed-precision
